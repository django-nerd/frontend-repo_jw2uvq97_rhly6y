    ...
    <section id="services" className="relative py-24 bg-slate-950">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="mt-4 text-slate-300/90">Four pillars to power growth across marketing, automation, apps, and 3D.</p>
        </div>

        <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map(({ icon: Icon, title, desc, accent }) => (
            <div key={title} className="group relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 overflow-hidden hover:translate-y-[-2px] transition-transform">
              ...
              <div className="relative">
                ...
                <div className="mt-6">
                  <a href="#services-details" className="text-sm text-cyan-300 hover:text-white">Learn more →</a>
                </div>
              </div>
            </div>
          ))}
